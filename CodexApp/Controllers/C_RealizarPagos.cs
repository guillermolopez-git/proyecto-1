...
namespace CodexApp.Controllers
{
    [ApiController]
    [Route("api/pagos")]
    public class C_RealizarPagos: Controller
    {
        private readonly PagoQueue _pagoQueue; // Para agregar pagos a la cola
        private readonly A_DatosIniciales _initialData; // Informacion de las tarjetas de credito
        private readonly QuerySaldo _querySaldo;// Para los eventos 


        public C_RealizarPagos(PagoQueue pagoQueue, A_DatosIniciales initialData, QuerySaldo querySaldo)
        {
